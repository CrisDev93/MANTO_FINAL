...
public final class MCUListarEstadosA 
        extends MappingDispatchAction {

    private Log log = LogFactory.getLog(MCURegistrarUsuario.class);


    public ActionForward solicitarListarEstadosA(
        ...
        if (log.isDebugEnabled()) {
            log.debug(">solicitarListarEstadosA");
        }
        ...
        FormaListadoEstadosA forma = (FormaListadoEstadosA)form;
