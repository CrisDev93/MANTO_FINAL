...
public final class MCUListarAutos 
    ...
    public ActionForward solicitarListarAutos(
        ...
        ManejadorEstadosA mr2 = new ManejadorEstadosA();
        Collection resultado2 = mr2.listarEstadosA();

        forma.setEstadosa( resultado2 );
    ...
    public ActionForward solicitarOrdMarcas(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
